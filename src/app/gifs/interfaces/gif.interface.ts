// To parse this data:
//
//   import { Convert, ShearchGIFResponse } from "./file";
//
//   const shearchGIFResponse = Convert.toShearchGIFResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ShearchGIFResponse {
    data:       Gif[];
...
export class Convert {
    public static toShearchGIFResponse(json: string): ShearchGIFResponse {
        return cast(JSON.parse(json), r("ShearchGIFResponse"));
    }

    public static shearchGIFResponseToJson(value: ShearchGIFResponse): string {
        return JSON.stringify(uncast(value, r("ShearchGIFResponse")), null, 2);
    }
}
